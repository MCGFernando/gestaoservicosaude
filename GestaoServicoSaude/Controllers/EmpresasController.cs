...
namespace GestaoServicoSaude.Controllers
{
    public class EmpresasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,RazaoSocial,NIF,Activo")] Empresa empresa)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,RazaoSocial,NIF,Activo")] Empresa empresa)
        {
            if (id != empresa.Id)
            {
                return NotFound();
